...
bind mount (importante) 
docker run -d -p 80:80 --name phpmessages_container -v /Users/frameticket/Documents/github/course_docker/php:/var/www/html/ --rm phpmessages